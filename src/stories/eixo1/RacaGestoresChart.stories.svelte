<script module lang="ts">
  ...
  import RacaGestoresChart from '$lib/components/eixo1/RacaGestoresChart.svelte';
  import StoryFrame from '$lib/components/eixo1/StoryFrame.svelte';

  const { Story } = defineMeta({
    title: 'Cultura em Números/Eixo 1/Gestão e Participação/Gestão municipal/Cor-raça dos gestores',
